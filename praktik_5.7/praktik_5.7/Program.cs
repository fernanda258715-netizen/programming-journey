        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (!int.TryParse(Console.ReadLine(), out pilihan))
                {
                    ...
                    // Tetap nilai selain 3 agar loop berlanjut
                    pilihan = 0;
                    continue;
                }
                // proses pilihan
                switch (pilihan)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        Console.WriteLine("Anda memmilih: Tambah Data.");
                        break;
                    case 3:
                        Console.WriteLine("Program akan berhenti...");
                        break; // keluar dari switch
                    default:
                        Console.WriteLine("Pilihan di luar jangkaun. Harap masukkan angka 1, 2, atau 3.");
                        break;
                }
            ...
            Console.WriteLine("Terima kasih telah meenggukan aplikasi.");
        }
    }
}
