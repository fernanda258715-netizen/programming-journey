...
namespace prakrik_6._3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            // Membuat array untuk menyimpam dengan nama dan nilai 3 siswa
            string[] nama = new string[3];
            int[] nilai = new int[3];

            // Input nama dan nilai siswa dari keyboad
            Console.Write("Masukkan nama iswa ke-1: ");
            ...
            Console.Write("Masukkan nilai ke3: ");
